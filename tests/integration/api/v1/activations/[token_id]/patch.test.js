...
describe("PATCH /api/v1/activations/[token_id]", () => {
  describe("Anonymous user", () => {
    test("With nonexistent token", async() => {
        const response = await fetch("http://localhost:3000/api/v1/activations/00000000-0000-0000-0000-000000000000", {
          method: "PATCH",
        }
      );
  ...
  expect(responseBody2).toEqual({
    ...
    test("With valid token", async() => {
        ...
        expect(expiresAt - createdAt).toBeGreaterThanOrEqual(activation.EXPIRATION_IN_MILISECONDS - 1000);
        expect(expiresAt - createdAt).toBeLessThanOrEqual(activation.EXPIRATION_IN_MILISECONDS + 1000);
  ...
  describe("Default user", () => {
    test("With valid token, but already logged in user", async() => {
      ...
      const response = await fetch(`http://localhost:3000/api/v1/activations/${user2ActivationToken.token}`, {
        method: "PATCH",
        headers: {
